/* =========================================
   LUNIVA LANDING PAGE — HTML BLOCK JS
   Version: 1.0.0
...
(function () {
  ...
  document.documentElement.setAttribute('data-luniva-landing-html-js', VERSION);
  ...
  function bindDelegatedEventsOnce() {
    if (window.__lunivaLandingHtmlEventsBound) return;
    window.__lunivaLandingHtmlEventsBound = true;
  ...
  // Does NOT intercept /cart, /checkout, or /products/ links
  ...
  // ═══════════════════════════════════════
  // LOAD MORE BUTTON — show if hidden cards exist
  // ═══════════════════════════════════════
  function initLoadMoreButton() {
    var btn = document.querySelector('.load-more-reviews button');
    if (!btn) return;
